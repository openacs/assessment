...
ad_proc -public as::item_display_cb::new {
    ...
    db_transaction {
        set item_item_display_cb_id [content::item::new -parent_id $folder_id -content_type {as_item_display_cb} -name [as::item::generate_unique_name]]
...
ad_proc as::item_display_cb::set_item_display_type {
    -assessment_id
    -section_id
    -as_item_id
    -after
