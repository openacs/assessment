...
ad_proc -public as::item_form::add_item_to_form  {
    ...
    Add items to a form. The form values are stored in
    ...
    if {$random_p == "f"} {
	set item_data [util_memoize [list \
                                         as::item_type_$item(item_type)\::render \
	...
	set item_data [as::item_type_$item(item_type)\::render \
                           -type_id $item(item_type_id) \
