...
of each section, or from the link that show the number of triggers
related to an item.</p><div class="screenshot"><div class="mediaobject"><img src="resources/checks_admin.JPG"></div></div><p>If the trigger administration page is reached from thi link of
