...
Manual"
			rightLink="ch02s04" rightLabel="Next">
...
to the trigger, when the assessment is being responded.</p></li></ul></div><p>The link to create a trigger appears in the action bar of the
items with multiple choice responses of the assessment.</p><div class="screenshot"><div class="mediaobject"><img src="resources/add_trigger.JPG"></div></div>
</div>
<include src="/packages/acs-core-docs/lib/navfooter"
			leftLink="ch02s02" leftLabel="Prev" leftTitle="2. Actions
Administration "
			rightLink="ch02s04" rightLabel="Next" rightTitle=" 4. Branch
Triggers"
