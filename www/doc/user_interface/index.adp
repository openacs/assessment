...
<body>
<!-- START HEADER --><h1><span class="context">Introduction</span></h1><span class="context">In recent times the survey system has
...
for feedback for quality assurance.</span><p><span class="context">On the other hand the need for dotLRN has
...
store them in an easy retrievable way.</span></p><p><span class="context">Last but not least a new demand has risen
for the possibility to give and store ratings on objects within the
system as part of a knowledge management solution.</span></p><p><span class="context">The documents on these page will provide a
solution that is flexible to meet ababove needs but still be
focused enought to apply for special clients demands.</span></p><h1><span class="context">Assessments</span></h1><span class="context">The current survey system will build the
basis for a new assessment package and will consist of various
areas:</span><h2><span class="context">Question Catalogue</span></h2><span class="context">The question catalogue stores all the
...
by the respondee). A detailed description can be found <a href="question_catalogue">here</a>.</span><h2><span class="context">Assessment creation</span></h2><span class="context">An assessment is either a survey or a test.
...
</span><p><span class="context">Each assessment consists of various
...
<a href="sections">here</a>.</span></p><h2><span class="context">Tests</span></h2><span class="context">Tests are a special kind of assessment in
...
<a href="tests">here</a>.</span><p><span class="context">The backend for the test processing, that
...
grading package.</span></p><h1><span class="context">Scoring/Grading</span></h1><span class="context">The grading package will be designed first of
...
student did a good oral exam).</span><p><span class="context">In addition to the possiblity to enter
...
challange.</span></p><p><span class="context">Furthermore the grading package offers to
...
(where they got good ratings for).</span></p><p><span class="context">Last but not least, maybe embeded with the
...
module to achieve.</span></p><h1><span class="context">User Experience</span></h1><span class="context">So far we have only talked about the
...
administrator settings.</span><h1><span class="context">Use Cases</span></h1><span class="context">The most obvious use case would be a class in
...
assessment system has been written mainly with this in mind.</span><p><span class="context">Additionally you can use the assessment
...
"change basic information" as one assessment among many.</span></p><p><span class="context">With a little bit of tweaking and the
possiblity to add instant gratification, aka aggregated result
display, it could include the poll package and make it
redundant.</span></p><p><span class="context">Last but not least with the ability to
...
been used for as well (e.g. plain and simple surveys).</span></p><p><span class="context">The grading system on it's own would be
...
give rated feedback to users.</span></p><blockquote><p><span class="context">
<br><br><br><br><br><br><br><br><br><br><br><br>
</span></p></blockquote><span class="context">
