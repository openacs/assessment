...
wouldn't. </p><p>Attributes of Assessments will include those previously included
in Surveys plus some others:</p><ul>
<li>assessment_id</li><li>cr:name - a curt name appropriate for urls<br>
</li><li>cr:title - a formal title to use in page layouts etc</li><li>creator_id - Who is the "main" author and creator of this
assessment</li><li>cr:description - text that can appear in introductory web
...
OpenACS app, or a "web service" via SOAP etc</li><li>editable_p - whether the response to the assessment is editable
...
thank you page context, so we can have a "continue" URL.</li><li>start_time - At what time shall the assessment become available
...
file or video file</li><li>numeric_value - optional "number of points" for section</li><li>feedback_text - optional preset text to show user</li><li>max_time_to_complete - optional max number of seconds to
perform Section</li>
</ul><p>Permissions / Scope: Control of reuse previously was through a
...
grid (see <a href="http://www.epimetrics.com/demos">the SAQ</a> for
an illustration of this).
<p>This entity is directly analogous in purpose and design to
as_item_display_types.</p><ul>
<li>section_display_type_id</li><li>section_type_name - name like "Vertical Column" or "Depth-first
Grid" or "Combo Box"</li><li>pagination_style - all-items; one-item-per-page; variable (get
...
discussion of Items and Item Choices <a href="http://openacs.org/projects/openacs/packages/assessment/design/as_items">
...
their labels -- displayed in a grid (see <a href="http://www.cvoutcomes.org/questionnaires/one-questionnaire?questionnaire_id=5">
...
last, for instance).</li><li>what others?</li>
</ol>
...
<ol>
<li>beside_left - the Items are left of the "heading"</li><li>beside_right - the Items are right of the "heading"</li><li>below - the Items are below the "heading"</li><li>above - the Items are above the "heading"</li>
</ol>
...
<ul>
<li>item_id</li><li>section_id</li><li>enabled_p</li><li>required_p - whether Item must be answered</li><li>item_default</li><li>content_value - references CR</li><li>numeric_value - where optionally the "points" for the Item can
be stored</li><li>feedback_text</li><li>max_time_to_complete</li><li>adp_chunk - display code</li><li>sort_order</li>
</ul>
