...
keeping with current OpenACS best practice.</p>
...
entities to make this difference clear.</p>
...
and internationalization through the CR.</p>
<h2>Synopsis of The Data Model</h2>
<p>Here's a detailed summary view of the entities in the Assessment
