...
<body>
<h2>Overview</h2><p>Through the OpenACS templating system, the UI look&amp;feel will
...
Assessment package will use these OpenACS standards:</p><ul>
...
interface widget like toolbars)</li><li>in-place, within-form user feedback (eg error messages about a
form field directly next to that field, not in an "error
page")</li>
</ul><p>Furthermore, the set of necessary pages for Assessment are not
...
blurred.</p><h2>Proposed Page Flow</h2><p>Nevertheless, here is a proposed set of pages along with very
...
have a look).</p><p>The UI for Assessment divides into a number of primary
functional areas, as diagrammed below. These include:</p><ul>
<li>the "Home" area (for lack of a better term). These are the main
index pages for the user and admin sections</li><li>
...
mechanisms reside.</li><li>Site Management: pages involved in setting up who does
...
.LRN:<span class="context"><span class="reg"><br></span></span><ul>
...
More Ideas:<span class="reg"><br></span><ul>
