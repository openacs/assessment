...
common to all as_item types.</span><ul>
<li><span class="context">as_item_id</span></li><li><span class="context">cr::name - some phrase used in admin
UIs</span></li><li><span class="context">cr::title - the primary "label" attached
to an as_item's display</span></li><li><span class="context">cr::description - some descriptive
...
types supported in the RDBMS:</span><ol>
...
varchar; of form 9.999e99</span></li><li><span class="context">varchar</span></li><li><span class="context">text</span></li><li><span class="context">date</span></li><li><span class="context">boolean (char(1) 't' 'f' in
Oracle)</span></li><li><span class="context">timestamp (should work for all coarser
...
allows specific access to an item.</span></li><li><span class="context">Write: Author can reuse and change this
...
regexp)</li><li>regexp_text: If the compare_by is a "regexp", this field
contains the actual regexp.</li><li>allowed_answerbox_list - list with all answerbox ids (1 2 3 ...
...
child to an as_item_type Object. Note the difference. <span style="font-weight: bold;">A choice does not belong to an as_item, but to
the instance of the as_item_type!</span> This way we can reuse
...
to the developer how this translates.</span></span></li><li>box_orientation - the pattern by which 2..n answer boxes are
...
<ol>
<li>beside_left - the "answers" are left of the "question"</li><li>beside_right - the "answers" are right of the "question"</li><li>below - the "answers" are below the "question"</li><li>above - the "answers" are above the "question"</li>
</ol><br>
</li>
</ul>
...
Internationalization?) and include:</span></span></span></span><ol>
<li><span class="context">beside_left - the "answers" are left of
the "question"</span></li><li><span class="context">beside_right - the "answers" are right of
the "question"</span></li><li><span class="context">below - the "answers" are below the
"question"</span></li><li><span class="context">above - the "answers" are above the
...
<span class="context"><span class="reg"><span class="context"><span class="reg"><span class="context"><span class="reg">item_answer_alignment - the orientation between the "question
part" of the Item (the title/subtext) and the "answer part" -- the
native Item widget (eg the textbox) or the 1..n choices.
Alternatives accommodate L-&gt;R and R-&gt;L alphabets (or is this
