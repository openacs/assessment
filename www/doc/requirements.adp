...
with non-OpenACS systems, etc.</li><li>mechanisms to embed Assessment capabilities within other
...
(which has been verified by the university) at the end.</li><li>Students have to print out their test and sign every page to
make sure the answers in the system are identical to the ones the
student has given.</li><li>In a purely multiple choice environment, the Test might be
...
<p>[A Question improves the test in reliability if it
...
effective dates (start,stop), deployment status (development,
testing, deployed, ended), whether it can be shared or cloned,
associated logo, etc.</li><li>The composition of an Assessment consisting of one or more
Sections, or even other pre-made Assessments.</li><li>The criteria that determine when a given Assessment is
complete, derived from completion criteria rolled up from each
constituent Section.</li><li>Navigation criteria among Sections -- including default paths,
randomized paths, rule-based branching paths responding to
user-submitted data, and possibly looping paths.</li><li>Whether the Assessment metadata (structure, composition,
sequencing rules etc) can be altered after data collection has
begun (scored Assessments may not make any sense if changed midway
through use).</li><li>Other measured parameters of how an Assessment gets performed
-- total elapsed time, time per Section, time per Item</li><li>Configuration of state transitions of an Assessment, depending
on context of its deployment. For instance:
<ul>
<li>In education, an Assessment might be: Unbegun, Partially Begun,
Submitted, Revised, Finally Submitted, Auto-graded, Final Manually
Graded, Reviewed by Student, Reviewed by Student and Teacher
Together</li><li>In clinical trials, the process is complex and dependent on
whether "double entry" is needed; see <a href="http://openacs.org/storage/download/data-entry-fsm.jpg?version_id=165168">
this FSM diagram</a> for an illustration.</li>
</ul>
</li><li>Scheduling: number of times user can perform Assessment;
whether user can revise a completed Assessment; whether a user can
interrupt and resume a given Assessment</li><li>Control of access permissions for all components of the
...
information), etc.</li><li>The composition of Items in a Section.</li><li>The formatting of Items in a Section -- vertical or horizontal
orientation, grid patterns, column layouts, etc.</li><li>The criteria that determine when a given Section is complete,
derived from submitted data rolled up from the constituent
...
can be returned to user based on user response. -- either while
subject is taking Assessment or later when subject is reviewing the
"graded" Assessment.</li>
</ul>
</li><li>Create, edit, clone and delete post-submission Assessment
...
appropriate) graphical display</li><li>Define time-based, sortable searches of Assessment data for
conversion into configurable file formats for download</li><li>Define specific searches for display of data quality
