...
<queryset>
	...
	<fullquery name="query_all_items">
		<querytext>
			SELECT as_itemsx.as_item_id, as_itemsx.name, as_itemsx.title, as_item_section_map.feedback_text
	...
	<fullquery name="choices">
		<querytext>
                SELECT
                as_item_choicesx.choice_id, as_item_choicesx.title AS choice_title, as_item_choicesx.correct_answer_p, as_item_choicesx.percent_score, as_item_datax.choice_id_answer
